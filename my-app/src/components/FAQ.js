    ...
    <section className="faq-section" id="faq">
      ...
      <h2 className="subheading-1">Kan man bara beställa en produkt?</h2>
        <p className="main-body long">
          Det går inte att beställa färre än 25st produkter då vi använder ett bulksystem för att dra ner priserna till våra företagskunder.
        </p>
      </div>
      <div className="faq-item">
      <h2 className="subheading-1">Kan en privatperson beställa hos er?</h2>
        <p className="main-body long">
          Det går jättebra men eftersom vi arbetar med bulk måste beställningen överskrida 25st artiklar.
        </p>
      </div>
  ...
  <p className="main-body long">
    ...
    Vi kommer att kontrollera din offert och återkomma med förslag på tryck och eventuella anpassningar. Om du är nöjd med förslaget skickar vi en korrektur orderbekräftelse. När du godkänner denna bekräftelse sätter vi igång med att beställa produkterna till tryckeriet, där de trycks, packas och levereras direkt till dig.
      ...
      <div className="faq-item">
        ...
        <p className="main-body long">
          – Vi skickar alltid en detaljerad korrektur med ditt tryck på vald produkt, antingen vet du själv exakt hur du vill ha det annars kommer vi gärna med förslag. I korrekturen ser du tydligt hur dina produkter kommer att se ut.
        </p>
      </div>
      ...
      <div className="faq-item">
        ...
        <p className="main-body long">
          ...
          <br />
          Alla prover vi skickar ut kommer utan tryck, detta då förberedelserna inför 1 tryck kräver både mycket tid och resurser. Istället jobbar vi med tydliga korrekturer så du tydligt får se innan hur ditt tryck kommer se ut innan du godkänner ordern.
        </p>
      </div>
      ...
      <div className="faq-item">
        ...
        <p className="main-body long">
          ...
          <br />
          Storlekar, plaggfärger och modeller får blandas fritt, önskas extra färgbyte för tryckfärgen (t.ex. någa plagg har vita tryck och några har svarta tryck) kostar det 170 SEK per färg. För brodyr är minimum 10 st brodyrer, även här kan du blanda produkter inom samma brodyromgång.
        </p>
      </div>
      ...
      <div className="faq-item">
        ...
        <p className="main-body long">
          – Hos oss kan du välja upp till 8 tryckfärger i hela PMS-färgskalan, oftast har du din logotyp i PMS och då går vi direkt efter den. Har du den i CMYK eller RGB så hjälper vi dig ta fram den färg som matchar bäst. Genom screentryckt rastertryck kan vi även trycka fotomotiv. Det går även bra att beställa våra produkter utan tryck om så önskas.
        </p>
      </div>

      <div className="faq-item">
        <h2 className="subheading-1">Vilket typ av tryck ska jag välja?</h2>
        <p className="main-body long">
      ...
      <div className="faq-item">
        ...
        <p className="main-body long">
          ...
          Denna kostar 825 SEK per motiv.
        </p>
      </div>
